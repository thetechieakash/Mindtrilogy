    ...
    <div class="container position-relative">
        ...
        <nav class="breadcrumbs">
            <ol>
                ...
                <li class="current">IT Strategy</li>
            </ol>
        </nav>
    </div>
</div><!-- End Page Title -->
            ...
            <div class="col-xl-12">
                <div class="services-details-thumb-wrapper">
                    <div class="services-details-thumb">
                        <img src="<?= base_url('assets/img/services/sec/service1.webp') ?>" alt="image">
                    </div>
                    <div class="services-details-thumb">
                        <img src="<?= base_url('assets/img/services/sec/service2.webp') ?>" alt="image">
                    </div>
                </div>
                <div class="services-details-wrapper">
                    <div class="services-details-left">
                        <div class="services-details-content">
                            ...
                            <p class="services-details-description">We denounce with righteous indignation and dislike
                                men who are so beguiled and demor alized by the charms of pleas ure of the moment, so
                                blinded by desire.Neque qui is dolor emr ipsum quia dolor eque porro quisquam est.Tortor
                                montes platea iacu lis posuere per mauris, eros porta blandit curabitur ullamcorper
                                varius, nostra ante risus egestas suscipit. Quisque interdum nec parturient</p>
                        </div>
                    </div>
    ...
    <div class="container">
        ...
        <div class="steps-grid">
            <div class="step-card">
                ...
                <p>We begin by assessing your business challenges, technology gaps, and goals to craft a tailored consulting roadmap for success.</p>
            ...
            <div class="step-card">
                ...
                <p>Our experts define actionable strategies, timelines, and resource allocation to ensure efficient execution with measurable business outcomes.</p>
                <div class="step-arrow">
                    <i class="bi bi-arrow-right"></i>
                </div>
            </div>
            ...
            <div class="step-card">
                ...
                <p>We guide deployment, integrate solutions, and provide technical oversight to align systems with your long-term vision and operational goals.</p>
                <div class="step-arrow">
                    <i class="bi bi-arrow-right"></i>
                </div>
            </div>
            ...
            <div class="step-card">
                ...
                <p>After delivery, we refine solutions, monitor performance, and suggest improvements to maintain growth, scalability, and future readiness.</p>
            </div>
        </div>
        ...
        <div class="row align-items-xxl-center  g-5">
            ...
            <div class="col-xl-7 col-lg-7">
                <div class="about-content-wrapper mt-lg-5">
                    <p class="about-description">We understand you may have questions before choosing a consulting partner. Here are clear answers to help you understand our expertise and approach.</p>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExampleOne">
                                            <div class="accordion-body">
                                                We provide IT consulting, custom software development, cloud solutions, staff augmentation, and digital transformation services designed to align with your business needs.
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#headingTwo">
                                            <div class="accordion-body">Yes, we share case studies and project portfolios that showcase our successful collaborations across industries like healthcare, finance, eCommerce, and more.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#headingThree">
                                            <div class="accordion-body">We customize strategies by analyzing your goals, challenges, and market environment. Our approach ensures scalable, cost-effective solutions tailored specifically for your business growth.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
